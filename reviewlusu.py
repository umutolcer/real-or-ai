...
if st.session_state.current_round >= len(rounds):
    ...
    st.html(
        ...
        <div class="review-subtitle">
            Open a round to see the media again and compare
            your answer with the correct answer.
        </div>
        """
    )
    ...
    for response in st.session_state.responses:
        ...
        with st.expander(expander_title):
            ...
            if response["correct"]:
                ...
                st.html(
                    ...
                    <div class="correct-box">
                        ...
                        Correct answer:
                        <strong>{response["ground_truth"]}</strong><br>
                        Confidence:
                        <strong>{response["confidence"]}/5</strong>
                    </div>
                    """
                )
            ...
            # ------------------------------------------
            # SPECIAL NOTE FOR ZACH KING VIDEO
            # ------------------------------------------

            if round_data["notes"] == "edited_non_ai":

                st.info(
                    "This video is edited/manipulated using traditional "
                    "visual effects, but it is not AI-generated."
                )
